...
public class StockRunner {
	public static void main(String[] args) {
		...
		String dataDirectory2 = "/Users/ethansong/Documents/GitHub/highlighter/Neural Network Test/CurrentData/"+comp+"CurrentData.csv";
		String outcomesDirectory = "/Users/ethansong/Documents/GitHub/highlighter/Neural Network Test/Outcomes/OctoberToNovember" + comp + "Outcomes.csv";
		CSVReadWrite.writeCsv(CurrentDataCollector.DataCollection(comp), dataDirectory2);	
		ArrayList<double[]> test = new ArrayList<double[]>();
		double[] testing = new double[3];
		test.add(testing);
		//CSVReadWrite.readCsv("/Users⁩/⁨ethansong⁩/⁨Documents⁩/GitHub⁩/highlighter⁩Neural Network Test⁩▸UltraBig⁩");
		...
		ArrayList<double[]> data = CSVReadWrite.readCsv(dataDirectory2);
		ArrayList<double[]> dataTaylored = data;
		ArrayList<double[]> pseudorandomData = CSVReadWrite.readCsv(dataDirectory2);
		...
		for(int m = 0; m<1; m++) {
			...
			CSVReadWrite.writeCsvStockOutcomes(finalAnsArr, comp, outcomesDirectory);
			//System.out.println();
