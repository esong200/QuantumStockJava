...
public class FiveLayerPseudorandom {
	public static void main(String[] args) {
		...
		double[][] synapticWeights1 = new double[synapticWeights0[0].length][18];
		double[] intermediateAnswer1 = new double[synapticWeights1[0].length];
		double[][] synapticWeights2 = new double[intermediateAnswer1.length][14];
		...
		try {
			...
			synapticWeights0 = new double[inputs.length][25];
			intermediateAnswer0 = new double[synapticWeights0[0].length];
			synapticWeights1 = new double[synapticWeights0[0].length][18];
			intermediateAnswer1 = new double[synapticWeights1[0].length];
			synapticWeights2 = new double[intermediateAnswer1.length][14];
			intermediateAnswer2 = new double[synapticWeights2[0].length];
			synapticWeights3 = new double[intermediateAnswer2.length][10];
			intermediateAnswer3 = new double[synapticWeights3[0].length];
			synapticWeights4 = new double[intermediateAnswer3.length][desiredOutcome.length];
			finalAnsArr = new double[desiredOutcome.length];
